...
import { handleCreateOrder, handleGetAllOrdersAdmin, handleNewPayment, handleSendStripePublishableKey, } from "../controllers/orderController";
...
orderRouter.get("/get-all-orders-admin", handleUpdateAccessToken, isAuthenticated, authorizeRoles("admin"), handleGetAllOrdersAdmin);
