    ...
    <div className="w-11/12  lg:w-11/12 2xl:w-5/6 mx-auto grid grid-cols-1 lg:grid-cols-2 items-start my-10 2xl:my-20">
      <div className="flex flex-col gap-5 lg:gap-8  2xl:gap-10  ">
        <div className="flex flex-col gap-5">
          ...
          <p className="text-[clamp(28px,5vw,70px)]  font-black text-center lg:text-left leading-[1.3]">
        ...
        <p className="text-text1 text-center lg:text-left font-medium text-base sm:text-lg   mx-auto  lg:mx-0 lg:text-lg xl:text-xl  sm:w-2/3 lg:w-4/5 2xl:w-3/4">
